...
//    log.info("Streaming chat request:{} ", collect);
   ...
   * @param format The format to return the response in. It can either be the String "json" or a Map
  ...
  public record ChatResponse(
    ...
    public Duration getPromptEvalDuration() {
      return (this.promptEvalDuration() != null)
          ? Duration.ofNanos(this.promptEvalDuration())
          : null;
    }
  ...
  @JsonInclude(Include.NON_NULL)
  public record ListModelResponse(@JsonProperty("models") List<Model> models) {}
  ...
  @JsonInclude(Include.NON_NULL)
  public record DeleteModelRequest(@JsonProperty("model") String model) {}
