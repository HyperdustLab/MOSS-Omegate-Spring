...
public class ChunkController {
  ...
  public void createNodes() {
    var fileDir =
        new File("F:\\workspace\\code\\learn\\sec-edgar-notebooks\\data\\sample\\form10k");
  ...
  public void createEmbedding() {
    ...
    List<Chunk> waitToEmbedList = chunkRepository.findByTextEmbeddingIsNullAndUserId(userId);
    waitToEmbedList.forEach(
        chunk -> {
          chunk.setTextEmbedding(floatsToDoubles(embeddingModel.embed(chunk.getText())));
